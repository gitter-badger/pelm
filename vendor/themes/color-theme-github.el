...
(defun color-theme-github ()
  ...
  (color-theme-install
   '(color-theme-github
     ...
     (erb-comment-delim-face ((t (:italic nil :bold t :slant normal :foreground "#999988" :weight bold))))
     ...
     (font-lock-comment-delimiter-face ((t (:italic nil :slant normal :foreground "#999988"))))
     (font-lock-comment-face ((t (:italic nil :foreground "#999988" :slant normal))))
