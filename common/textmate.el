...
(defvar *textmate-gf-exclude* "/\\/\\.|(\\/|^)(\\.|vendor|fixtures|tmp|log|build)($|\\/)|(\\.xcodeproj|\\.nib|\\.svn|\\.framework|\\.app|\\.pbproj|\\.pbxproj|\\.xcode|\\.xcodeproj|\\.bundle|\\.pyc)$"
  "Regexp of files to exclude from `textmate-goto-file'.")
;; added requires for brayma project
(defvar *textmate-project-roots*
  '(".git" "requires.php" ".hg" "Rakefile" "Makefile" "README" "build.xml" ".emacs-project")
